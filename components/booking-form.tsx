        ...
        <Tabs value={bookingType} onValueChange={setBookingType} className="w-full">
          ...
          <TabsContent value="room">
            <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
              ...
              <Button type="submit" className="w-full bg-[#c9a227] hover:bg-[#b08d22] text-white py-6 text-lg">
            ...
            <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select required value={serviceType} onValueChange={setServiceType} aria-label="Select service type">
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="food-workshop">Thai Food Workshop</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select required value={participants} onValueChange={setParticipants}>
                    <SelectTrigger>
