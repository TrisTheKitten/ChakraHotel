...
export default function Location() {
  return (
    <section id="location" className="py-16 md:py-24 bg-[#f0e6d6]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif text-[#6d1d2a] mb-4">Our Location</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <Button
                className="bg-white text-[#6d1d2a] hover:bg-[#6d1d2a] hover:text-white"
          ...
          <div>
            <h3 className="text-2xl font-serif text-[#6d1d2a] mb-6">Find Us</h3>

            <div className="space-y-6">
              <div className="flex items-start">
                <MapPin className="h-6 w-6 text-[#6d1d2a] mr-4 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <Phone className="h-6 w-6 text-[#6d1d2a] mr-4 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <Globe className="h-6 w-6 text-[#6d1d2a] mr-4 mt-1" />
                <div>
