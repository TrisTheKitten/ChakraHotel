    ...
    <section id="about" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif text-[#6d1d2a] mb-4">About Us</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h3 className="text-2xl font-serif text-[#6d1d2a] mb-4">
            ...
            <div className="bg-[#f0e6d6] p-6 rounded-lg mb-6">
              <h4 className="font-serif text-[#6d1d2a] text-xl mb-2 text-center">
