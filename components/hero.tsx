...
export default function Hero() {
  const slides = [
    ...
    {
      image: "/herbal-massage.jpg",
      title: "Authentic Thai Herbal Massage",
      subtitle: "Rejuvenate your body and mind with our traditional Thai wellness treatments",
    },
    {
      image: "/hotel-lobby-3.jpg",
      title: "Elegant Thai-Inspired Accommodations",
      subtitle: "17 unique rooms blending modern comfort with traditional Thai aesthetics",
    },
  ]
