...
export default function Footer() {
  return (
    <footer className="bg-[#6d1d2a] text-white">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex">
              ...
              />
              <button className="bg-[#c9a227] hover:bg-[#b08d22] px-4 py-2 rounded-r-md">Subscribe</button>
            </div>
          </div>
        </div>

        <div className="border-t border-white/20 mt-8 pt-8 text-center text-white/60">
          <p>&copy; {new Date().getFullYear()} Chakra Hotel. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
